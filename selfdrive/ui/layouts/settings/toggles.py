...
class TogglesLayout(Widget):
  ...
  def _convert_units(self, is_metric):
    ...
    # TODO: Probably more params need to get updated
    ...
    # TODO: Do we need to refresh the updated toggles in the ui?
