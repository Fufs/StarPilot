...
class StarPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.always_on_lateral_pause_on_brake_speed = self.get_value("AlwaysOnLateralPauseOnBrakeSpeed", cast=float, condition=toggle.always_on_lateral, conversion=speed_conversion)
